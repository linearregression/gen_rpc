...
-spec block_call(Node::node(), M::module(), F::atom()|function(),  SendTO::timeout()) ->  term() | {badrpc, term()}.
block_call(Node, M, F, SendTO) ->
    gen_rpc_client:block_call(Node, M, F, SendTO).

-spec block_call(Node::node(), M::module(), F::atom()|function(), A::list(), SendTO::timeout()) ->  term() | {badrpc, term()}.
block_call(Node, M, F, A, SendTO) ->
    gen_rpc_client:block_call(Node, M, F, A, SendTO).
